...
public class InputPlayer : MonoBehaviour, IInputPlayer
{
    ...
    void Update ()
    {
        ...
        Debug.Log("Raw: " + InputManager.GetAxisRaw(PlayerAxis.MoveHorizontal, this) + "\n" + "lmao: " + InputManager.GetAxis(PlayerAxis.MoveHorizontal, this)
            + "\tAxisDown: " + InputManager.GetAxisDown(PlayerAxis.MoveHorizontal, this));

        if (Input.GetKeyDown(KeyCode.Space))
            InputManager.SerializeInput();
