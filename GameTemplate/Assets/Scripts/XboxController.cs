...
public class XboxController
{
    ...
    private void InitializeDictionaries()
    {
        ...
        currentAxisDict = new Dictionary<XboxAxis, float>(previousAxisDict);

        // Initiailze the current XboxButton dictionary with Released ButtonState
        currentButtonDict = new Dictionary<XboxButton, ButtonState>(previousButtonDict);
    }
    ...
    private void UpdateDictionaries()
    {
        ...
        foreach (XboxAxis key in currentAxisDict.Keys)
            previousAxisDict[key] = currentAxisDict[key];

        // Transfer the current XboxButton dictionary values to the previous dictionary values
        foreach (XboxButton key in currentButtonDict.Keys)
            previousButtonDict[key] = currentButtonDict[key];
