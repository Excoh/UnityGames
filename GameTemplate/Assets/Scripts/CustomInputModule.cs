...
public class CustomInputModule : PointerInputModule
{
    ...
    [SerializeField]
    private PlayerAxis m_HorizontalAxis = PlayerAxis.UI_Horizontal;

    /// <summary>
    /// Name of the vertical axis for movement (if axis events are used).
    /// </summary>
    [SerializeField]
    private PlayerAxis m_VerticalAxis = PlayerAxis.UI_Vertical;

    /// <summary>
    /// Name of the submit button.
    /// </summary>
    [SerializeField]
    private PlayerButton m_SubmitButton = PlayerButton.UI_Submit;
    ...
    /// </summary>
    public PlayerAxis horizontalAxis
    {
    ...
    /// Name of the vertical axis for movement (if axis events are used).
    /// </summary>
    public PlayerAxis verticalAxis
    {
        get { return m_VerticalAxis; }
        set { m_VerticalAxis = value; }
    }

    public PlayerButton submitButton
    {
        get { return m_SubmitButton; }
        set { m_SubmitButton = value; }
    }

    public PlayerButton cancelButton
    {
    ...
    public override bool ShouldActivateModule()
    {
        ...
        shouldActivate |= !Mathf.Approximately(InputManager.GetAxis(m_HorizontalAxis), 0.0f);
        shouldActivate |= !Mathf.Approximately(InputManager.GetAxis(m_VerticalAxis), 0.0f);
    ...
    private Vector2 GetRawMoveVector()
    {
        ...
        move.x = InputManager.GetAxis(m_HorizontalAxis);
        move.y = InputManager.GetAxis(m_VerticalAxis);
